...
func main() {
	...
	router.GET("/login/:id/:name/", loginHandle)

	log.Fatal(http.ListenAndServe(":8000", router))

}

func loginHandle(w http.ResponseWriter, r *http.Request, ps httprouter.Params) {
	fmt.Fprintf(w, "hello %s - %s", ps.ByName("name"), ps.ByName("id"))
}
